...
class CreateJobseekerForm extends Form
{
  public function __construct(public array $attributes)
  {
    ...
    if (!Validator::check_if_empty($attributes['birth_date'])) $this->errors['birth_date_error'] = 'Please state your job position or the job position you are after. :)';
  ...
  public function register($attributes = []) 
  {
    ...
    App::resolve(Database::class)
        ->query(
          'insert into jobseekers(name, email, password, birth_date, profile_photo, salary_type, skills, summary, rate, position, work_background_company_name, work_background_position, work_background_duration) 
          values(:name, :email, :password, :birth_date, :profile_photo, :salary_type, :skills, :summary, :rate, :position, :work_background_company_name, :work_background_position, :work_background_duration)',
          [
