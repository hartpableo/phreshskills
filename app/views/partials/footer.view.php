...
<footer role="contentinfo">
  ...
  <section class="mb-3">
    <div class="has-overlay has-overlay-darker bg-center relative max-w-[1536px] bg-fixed bg-cover mx-auto px-3 text-center relative overflow-hidden isolate bg-black py-20 text-white flex flex-col justify-center items-center text-md lg:text-lg" style="background-image: url(<?php echo image_uri('hero-bg.webp'); ?>);background-repeat: no-repeat;">
      ...
      <h2
      class="sr-only"
      >Why launch this platform?</h2>
      
      <p class="max-w-2xl font-bold text-5xl leading-tight">This platform was made to help <span class="text-orange-500">Filipinos</span> jump-start their careers and for <span class="text-blue-500">companies or businesses worldwide</span> to find the right candidate for their team!</p>
