...
(5, 'HP Web Design', 'hart@hp.com', '$2y$10$tJCu8G.xW3xtYiXp7Q1lp.6hTJ7Mt4UulGZuLmnRQq5amFaMXoPca', 12);
...
INSERT INTO `jobseekers` (`id`, `name`, `email`, `password`, `summary`, `position`, `profile_image`, `skills`, `rate`, `salary_type`, `work_background_company_name`, `work_background_position`, `work_background_duration`) VALUES
(1, 'John Doe', 'jdoe@gmail.com', '', 'Lorem ipsum dolor sit amet consectetur adipiscing elit mattis gravida lobortis euismod, ultricies rutrum iaculis penatibus commodo sollicitudin erat interdum congue facebook.com eros, himenaeos fames mauris viverra suspendisse ullamcorper platea venenatis vitae torquent. Lacinia class lacus sapien nunc aliquam euismod, porttitor sed quam vitae malesuada magna faucibus, diam habitant duis taciti accumsan. Per semper suspendisse tristique nisl imperdiet euismod malesuada pulvinar sollicitudin facilisi litora, eu consequat senectus cubilia volutpat magnis facilisis ridiculus elementum eros. Laoreet neque erat sapien nam nostra aliquam torquent nec dapibus non, nisi pharetra lacus commodo metus volutpat leo cum aliquet, rhoncus hac maecenas mattis vestibulum primis tellus phasellus eget.', 'Web Developer', NULL, 'php, html, photoshop, css', '3', 'hourly', NULL, NULL, NULL),
(2, 'Jane Hoz', 'jhoz@gmail.com', '', 'Lorem ipsum hart@mmd.org.ph dolor sit amet consectetur adipiscing elit mattis gravida lobortis euismod, ultricies rutrum iaculis penatibus commodo sollicitudin erat interdum congue eros, himenaeos fames mauris viverra suspendisse ullamcorper platea venenatis vitae torquent. Lacinia class lacus sapien nunc aliquam euismod, porttitor sed quam vitae malesuada magna faucibus, diam habitant duis taciti accumsan. Per semper suspendisse tristique nisl imperdiet euismod malesuada pulvinar sollicitudin facilisi litora, eu consequat senectus cubilia volutpat magnis facilisis ridiculus elementum eros. Laor', 'Graphic Designer', NULL, 'photoshop, figma', '7.5', 'hourly', NULL, NULL, NULL),
(4, 'Test Name', 'tester@gmail.com', '$2y$10$Y1SfMaP3fuYSBhrNf0x2Y.BGORlINhjH5U0rNiKRn1gT4d/xmUA/m', 'Nisi sociosqu cras per torquent consequat accumsan fermentum https://marameodesign.com/ mollis auctor, imperdiet facilisis l', 'Virtual Assistant', NULL, 'photoshop, social media marketing, facebook ads', '13', 'weekly', NULL, NULL, NULL),
(8, 'Hart Pableo', 'hart123@mmd.com', '$2y$10$SMr/htXdd3pJAFOaXuBC6.Qq9LCMr5ywK78j7ZPl6qkFP3vtCkmJW', ' placerat id elementum felis et, suspendisse integer sollicitudin dapibus ultrices odio quisque sodales curae magnis. Faucibus natoque lacus suspendisse eleifend pretium aliquet ultricies, hac himenaeos mus tincidunt montes pulvinar eget nascetur, netus consequat facilisi porta sagittis vestibulum. Morbi mauris pellentesque odio commodo posuere per, proin eros risus id metus, hendrerit nibh penatibus neque vel. Nostra sodales nisi tempus vivamus sociosqu porttit', 'PHP Developer', NULL, 'HTML, CSS, PHP, Javascript, WordPress, TailwindCSS, Bootstrap, Drupal', '20', 'hourly', 'Proweaver, Marameo Design', 'WordPress Developer, WordPress & Drupal Developer', 'August 2021 - November 2022, November 2022 - Present'),
